...
instagram:
featured:
  [ "ReLaTeX", "Sistema Acadêmico", "Sistema de Avaliações", "Currículo (CV)" ]
extra:
  instagram: "fckpeeh"
...
repos:
  - name: "Finanças App"
    ...
    stack:
      [ "Node.js", "Express", "MongoDB", "Mongoose", "EJS", "JWT", "Zod", "Docker", "Helmet" ]
    tags:
      [ "Finanças", "Full-stack", "Web App", "Orçamento", "Investimentos" ]
    brief:
      pt: "Aplicação web pessoal de finanças: contas, transações, categorias, orçamentos e metas, com módulo de investimentos (ativos, trades, corretoras) e relatórios. Backend Node/Express + MongoDB, frontend EJS SSR, autenticação JWT, validação Zod e boas práticas de segurança (Helmet, rate-limit, CSP). Deploy via Docker Compose."
      en: "Personal finance web app: accounts, transactions, categories, budgets and goals, with an investments module (assets, trades, brokers) and reports. Node/Express + MongoDB backend, EJS SSR frontend, JWT auth, Zod validation and security hardening (Helmet, rate-limit, CSP). Deployed via Docker Compose."
      es: "Aplicación web personal de finanzas: cuentas, transacciones, categorías, presupuestos y metas, con módulo de inversiones (activos, trades, corredoras) e informes. Backend Node/Express + MongoDB, frontend EJS SSR, autenticación JWT, validación Zod y endurecimiento de seguridad (Helmet, rate-limit, CSP). Despliegue vía Docker Compose."
  ...
  - name: "Sistema Acadêmico"
    ...
    stack:
      [ "Node.js", "Express", "MongoDB", "Mongoose", "EJS", "JWT", "Docker", "vis-network" ]
    tags:
      [ "Full-stack", "Web App", "Academia", "CR/Boletim", "API Bot" ]
    brief:
      pt: "Web exclusivo para alunos de Eng. de Computação do IFF acompanharem grade, diário, notas, frequência, boletim/CR e planejamento. Fork do padrão de avaliações, com diário, ementário, grafo de dependências e API de ingestão por bot (Telegram). Deploy via Docker Compose + systemd."
      en: "Exclusive web app for Computer Engineering students at IFF to track curriculum, diary, grades, attendance, GPA/report card and planning. Fork of the evaluations standard, with diary, ementa, dependency graph and a Telegram-bot ingestion API. Deployed via Docker Compose + systemd."
      es: "Aplicación web exclusiva para alumnos de Ingeniería Informática del IFF para seguir malla, diario, notas, asistencia, CR/boletín y planificación. Fork del estándar de evaluaciones, con diario, ementario, grafo de dependencias y API de ingesta por bot de Telegram. Despliegue vía Docker Compose + systemd."
  ...
  - name: "Sistema de Avaliações"
    ...
    stack:
      [ "Node.js", "Express", "MongoDB", "LaTeX", "EJS" ]
    tags:
      [ "EdTech", "LaTeX", "Provas", "Multi-variantes" ]
    brief:
      pt: "Plataforma base de provas/listas/trabalhos em PDF a partir de um banco de questões reutilizável, com geração real em LaTeX e múltiplas variantes (seleção/ordem aleatórias). Núcleo professor+admin."
  ...
  - name: "Avaliações Professores"
    ...
    stack:
      [ "Node.js", "Express", "MongoDB", "LaTeX" ]
    tags:
      [ "EdTech", "Banco de Questões", "Colaborativo" ]
    brief:
      pt: "Fork do Sistema de Avaliações com banco pessoal + banco global compartilhado (fork de questões entre professores), PDF por pool com peso e gabarito opcional."
  - name: "Avaliações Concurseiro"
    ...
    stack:
      [ "Node.js", "Express", "MongoDB", "Expo", "LaTeX" ]
    tags:
      [ "Concursos", "Gamificação", "Mobile", "Simulados" ]
    brief:
      pt: "Fork focado em concurseiros: banco de MCQ, trilhas por edital, cronograma maleável, Pomodoro, simulados em PDF e app mobile Expo com paridade total de funcionalidades."
  - name: "Portal Acadêmico IFF (academicoWeb)"
    ...
    stack:
      [ "Web", "Node.js", "Scraping" ]
    tags:
      [ "Web App", "IFF", "Dashboard" ]
    brief:
      pt: "Sistema web que acessa os dados acadêmicos do IFF com as credenciais oficiais: dashboard, diário, material de aula, boletim e histórico escolar."
  - name: "ReLaTeX"
    cat: "software"
    visibility: "privado"
    icon: "latex"
    ...
    stack:
      [ "Docker", "Node.js", "MongoDB", "Redis", "Pug", "LaTeX" ]
    tags:
      [ "Overleaf Fork", "Self-hosted", "IFF", "LaTeX" ]
    brief:
      pt: "Fork do Overleaf Community Edition com identidade do IFF: classes oficiais embutidas (ifftese/iffposter), tema azul, landing própria e 10 botões extras no editor. Self-hosted via Docker (web+mongo+redis)."
  ...
  - name: "Verdementa"
    ...
    tags:
      [ "Suíte Comercial", "ERP" ]
    brief:
      pt: "Meta-repositório que agrupa Caixas, ControleEstoque, LevantamentoEstoque e Planilhador — suíte de ferramentas comerciais."
  - name: "Caixas"
    cat: "software"
    visibility: "privado"
    icon: "cash"
    ...
    stack:
      [ "Node.js", "CI" ]
    tags:
      [ "Controle de Caixa", "Relatórios" ]
    brief:
      pt: "Sistema para lançamento de controles de caixa com menus, relatórios e funcionalidades extras."
  - name: "ControleEstoque"
    ...
    tags:
      [ "Inventário", "Estoque" ]
    brief:
      pt: "Sistema de controle/contagem de inventário de estoque."
  - name: "LevantamentoEstoque"
    ...
    tags:
      [ "Estoque", "Compras" ]
    brief:
      pt: "Levantamento de itens que são alvo de compras repetidas."
  - name: "Planilhador"
    cat: "software"
    visibility: "privado"
    icon: "table"
    ...
    tags:
      [ "NFCe", "Planilhas" ]
    brief:
      pt: "Ferramentas NFCe / planilhamento."
  - name: "anomaly_detection"
    ...
    stack:
      [ "Python", "Astropy", "NumPy", "Pandas", "ML", "Jupyter" ]
    tags:
      [ "PIBIC/CNPq", "Gaia", "GALAH", "Astroquímica" ]
    brief:
      pt: "Análise das propriedades estelares e composição química das estrelas próximas do GCNS observadas pelo GALAH DR4 (Gaia DR3 + GALAH DR4). Bolsa PIBIC/CNPq; co-autoria PUC Chile (Dra. M. L. L. Dantas, Dra. A. C. Soja)."
  ...
  - name: "SpectraViewer"
    ...
    stack:
      [ "Python", "FITS", "Matplotlib" ]
    tags:
      [ "Espectroscopia", "GALAH DR4", "Open Source" ]
    brief:
      pt: "Viewer interativo de espectros GALAH DR4 (4 bandas, linhas de referência CNO/Alpha/Iron-peak, leitura de FITS, metadados Teff/log(g)/[Fe/H])."
  ...
  - name: "research"
    ...
    tags:
      [ "Literatura", "arXiv" ]
    brief:
      pt: "Anexos de pesquisa: busca de artigos no arXiv por assunto/keyword para compor leituras."
  ...
  - name: "Currículo (CV)"
    ...
    stack:
      [ "LaTeX", "altacv", "Makefile", "biblatex" ]
    tags:
      [ "Multilíngue", "PT/EN/ES/FR" ]
    brief:
      pt: "CV em LaTeX (classe altacv), multilíngue (PT/EN/ES/FR) compilado via Makefile. Inclui ORCID, Google Scholar e publicações em congressos (CONFICT, SAB, SBPC)."
  ...
  - name: "Cálculo Numérico"
    ...
    stack:
      [ "Python", "CI", "Docs", "NumPy" ]
    tags:
      [ "Disciplina", "Métodos Numéricos" ]
    brief:
      pt: "Repositório de códigos da disciplina Cálculo Numérico 2025.2, com CI e documentação."
  - name: "Formulários"
    cat: "academico"
    visibility: "público"
    icon: "formula"
    ...
    tags:
      [ "Resumos", "Fórmulas" ]
    brief:
      pt: "Coleção de folhas de fórmulas e resumos em LaTeX organizados por disciplina."
  - name: "Modelos LaTeX"
    cat: "academico"
    visibility: "privado"
    icon: "latex"
    ...
    tags:
      [ "Templates" ]
    brief:
      pt: "Modelos LaTeX para uso geral."
  - name: "page (Quartz)"
    cat: "pessoal"
    visibility: "público"
    icon: "globe"
    ...
    stack:
      [ "Quartz", "Obsidian", "MDX" ]
    tags:
      [ "Site Oficial", "Obsidian", "Multilíngue" ]
    brief:
      pt: "Site pessoal/acadêmico oficial, multilíngue (PT completo; EN/ES/FR parciais), em Quartz a partir do vault Obsidian. Publicado em github.io/page (migrando p/ www.phrandrade.com)."
  - name: "hardcore-life"
    cat: "pessoal"
    visibility: "privado"
    icon: "life"
    ...
    stack:
      [ "Obsidian", "PARA" ]
    tags:
      [ "Produtividade", "Second Brain" ]
    brief:
      pt: "Vault Obsidian de gestão de vida (PARA: projetos, áreas, recursos, arquivos) — 4000+ arquivos."
  - name: "dashboard-life"
    cat: "pessoal"
    visibility: "privado"
    icon: "dashboard"
    ...
    tags:
      [ "Life OS" ]
    brief:
      pt: "Dashboard de vida (derivado do hardcore-life)."
  - name: "guia-github"
    cat: "pessoal"
    visibility: "público"
    icon: "github"
    ...
    brief:
      pt: "Boas práticas, templates e exemplos de uso profissional do GitHub (Actions, Projects, Issues, Branching) para projetos Python."
  - name: "Perfil GitHub"
    cat: "pessoal"
    visibility: "público"
    icon: "profile"
    ...
    tags:
      [ "README" ]
    brief:
      pt: "README de perfil do GitHub (bio, Tech & Tools, featured projects)."
bolsas:
  - title:
      pt: "Entendendo a Matéria Escura a partir de Choques ExtraGalácticos"
      en: "Understanding Dark Matter from ExtraGalactic Shocks"
      es: "Entendiendo la Materia Oscura a partir de Choques ExtraGalácticos"
      fr: "Comprendre la Matière Noire à partir de Chocs ExtraGalactiques"
    icon: "darkmatter"
    kind:
      pt: "IC Júnior · CNPq"
      en: "Junior SI · CNPq"
    ...
    desc:
      pt: "Iniciação Científica Júnior sobre matéria escura e choques extragalácticos."
      en: "Junior Scientific Initiation on dark matter and extragalactic shocks."
      es: "Iniciación Científica Júnior sobre materia oscura y choques extragalácticos."
      fr: "Initiation Scientifique Junior sur la matière noire et les chocs extragalactiques."
  - title:
      pt: "MobFog no IFFMaker"
      en: "MobFog at IFFMaker"
      es: "MobFog en IFFMaker"
      fr: "MobFog à l'IFFMaker"
    icon: "fog"
    kind:
      pt: "IC · IFF"
      en: "SI · IFF"
    ...
    orient: "Dra. Ana Cecília Soja"
    desc:
      pt: "Projeto de Iniciação Científica do IFF (computação em névoa / edge)."
      en: "IFF Scientific Initiation project (fog/edge computing)."
      es: "Proyecto de Iniciación Científica del IFF (computación en niebla/edge)."
      fr: "Projet d'Initiation Scientifique de l'IFF (informatique en brouillard/edge)."
  - title:
      pt: "Simulando o Impacto de Satélites em Observações Astronômicas"
      en: "Simulating the Impact of Satellites on Astronomical Observations"
      es: "Simulando el Impacto de Satélites en Observaciones Astronómicas"
      fr: "Simuler l'Impact des Satellites sur les Observations Astronomiques"
    icon: "satellite"
    kind:
      pt: "Voluntário · CNPq"
      en: "Volunteer · CNPq"
    ...
    orient: "Dra. Ana Cecília Soja"
    desc:
      pt: "Simulação do impacto de rastros de satélites em imagens astronômicas."
      en: "Simulation of satellite-trail impact on astronomical images."
      es: "Simulación del impacto de rastros de satélites en imágenes astronómicas."
      fr: "Simulation de l'impact des traînées de satellites sur les images astronomiques."
  - title:
      pt: "Detecção de Anomalias em Estrelas da Via Láctea (Gaia + Surveys + ML)"
      en: "Anomaly Detection in Stars of the Milky Way (Gaia + Surveys + ML)"
      es: "Detección de Anomalias en Estrellas de la Vía Láctea (Gaia + Surveys + ML)"
      fr: "Détection d'Anomalies chez les Étoiles de la Voie Lactée (Gaia + Surveys + ML)"
    icon: "star"
    kind:
      pt: "IC · CNPq (PIBIC)"
      en: "SI · CNPq (PIBIC)"
    ...
    desc:
      pt: "Bolsa PIBIC/CNPq: aprendizado de máquina sobre Gaia DR3 + GALAH DR4 + GCNS para arqueologia galáctica e populações estelares. Co-autoria PUC Chile."
      en: "PIBIC/CNPq scholarship: machine learning on Gaia DR3 + GALAH DR4 + GCNS for galactic archaeology and stellar populations. Co-authorship PUC Chile."
      es: "Beca PIBIC/CNPq: aprendizaje de máquina sobre Gaia DR3 + GALAH DR4 + GCNS para arqueología galáctica y poblaciones estelares. Coautoría PUC Chile."
      fr: "Bourse PIBIC/CNPq : apprentissage automatique sur Gaia DR3 + GALAH DR4 + GCNS pour l'archéologie galactique et les populations stellaires. Co-autoria PUC Chile."
contacts:
  - icon: "mail"
    labelKey: "email"
